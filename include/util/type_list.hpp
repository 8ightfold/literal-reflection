...
namespace rflct::util {
    ...
    class Type_list
    {
        ...
        static constexpr inline auto get_at() {
        ...
        static constexpr inline size_t locate_impl() {
    ...
    public:
        ...
        static inline constexpr bool exists()
        {
        ...
        template <typename Ty>
        static inline constexpr size_t locate()
        {
            return locate_impl<Ty, 0, Type_list<TT...>::count_impl, TT...>();
        };
    ...
    {
    public:
        static inline constexpr size_t count() { return 0; };
    ...
    constexpr inline auto tl_flip(Type_list<T, TT...>)
    {
        return tl_flip<typename List::template prepend<T>::type>(Type_list<TT...>{});
    };

    template <typename List>
    constexpr inline auto tl_flip(Type_list<>) { return List{}; };
}
